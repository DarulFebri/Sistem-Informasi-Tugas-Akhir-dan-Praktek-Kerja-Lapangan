            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?php echo e($pengajuan->judul_tugas_akhir); ?></td>
                        <td><?php echo e($pengajuan->created_at->format('d M Y')); ?></td>
                        <td><?php echo e(Str::replace('_', ' ', Str::title($pengajuan->status))); ?></td>
                        <td>
                            <a href="<?php echo e(route('kajur.verifikasi.form', $pengajuan->id)); ?>" class="btn btn-primary">Verifikasi</a>
                        </td>
                    </tr>
...
</html><?php /**PATH /home/darulfebri/Documents/percobaan web laravel/gmni_1 sebelum mencoba timbal balik kaprodi dan dosen/gmni_1/resources/views/kajur/pengajuan/perlu_verifikasi.blade.php ENDPATH**/ ?>