...
<body>
    <div class="container">
        ...
        <div class="options">
            <a href="<?php echo e(route('mahasiswa.pengajuan.create', 'ta')); ?>">Pengajuan Tugas Akhir</a>
            <a href="<?php echo e(route('mahasiswa.pengajuan.create', 'pkl')); ?>">Pengajuan Praktek Kerja Lapangan</a>
        </div>
        <a href="<?php echo e(route('mahasiswa.dashboard')); ?>" class="back-link">Kembali ke Dashboard</a>
    </div>
</body>
</html><?php /**PATH /home/darulfebri/Documents/percobaan web laravel/gmni_1 kampus unand/gmni_1 sebelum mencoba timbal balik kaprodi dan dosen/gmni_1/resources/views/mahasiswa/pengajuan/pilih-jenis.blade.php ENDPATH**/ ?>