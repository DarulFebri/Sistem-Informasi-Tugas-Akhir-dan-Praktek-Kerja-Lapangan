...
<body>
    <div class="container">
        ...
        <?php if($pengajuanSiapSidang->isEmpty()): ?>
        ...
        <?php else: ?>
            <table class="table">
                ...
                <tbody>
                    <?php $__currentLoopData = $pengajuanSiapSidang; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pengajuan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        <td><?php echo e($pengajuan->id); ?></td>
                        <td><?php echo e($pengajuan->mahasiswa->nama_lengkap); ?></td> 
                        <td><?php echo e($pengajuan->jenis_pengajuan); ?></td> 
                        <td><?php echo e($pengajuan->created_at->format('d M Y')); ?></td>
                        <td><?php echo e(Str::replace('_', ' ', Str::title($pengajuan->status))); ?></td>
                        <td>
                            <a href="<?php echo e(route('kajur.sidang.show', $pengajuan->id)); ?>" class="btn btn-primary">Detail</a>
                        </td>
                    </tr>
...
</html><?php /**PATH /home/darulfebri/Documents/percobaan web laravel/gmni_1 kampus unand/gmni_1 sebelum mencoba timbal balik kaprodi dan dosen/gmni_1/resources/views/kajur/pengajuan/perlu_verifikasi.blade.php ENDPATH**/ ?>