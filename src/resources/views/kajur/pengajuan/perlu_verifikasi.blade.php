            ...
            <table class="table">
                <thead>
                    <tr>
                        ...
                        {{-- <th>Judul Tugas Akhir</th> --}} {{-- REMOVED THIS LINE --}}
                        <th>Jenis Pengajuan</th> {{-- ADDED THIS LINE --}}
                ...
                <tbody>
                    ...
                    <tr>
                        <td>{{ $pengajuan->id }}</td>
                        <td>{{ $pengajuan->mahasiswa->nama_lengkap }}</td> {{-- CORRECTED COLUMN NAME --}}
                        <td>{{ $pengajuan->jenis_pengajuan }}</td> {{-- DISPLAYING JENIS PENGAJUAN --}}
